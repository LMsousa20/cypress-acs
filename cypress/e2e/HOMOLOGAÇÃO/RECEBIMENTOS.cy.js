describe('RECEBIMENTOS MANUAIS', () => {
  ...
  context('Setup Inicial', () => {
    ...
    it('ACESSAR ULTIMA PRESTACAO', () => {
      ...
      cy.visit('/movimentos/caixas-de-venda').wait(1000);
      cy.get(':nth-child(2) > .cdk-column-edit_delete > crud_edit > #link-edit > .mat-icon').click().wait(1000);
  ...
  context('Adicionando Recebimentos de Cartão de Credito', () => {
    ...
    it('Cartão de Credito', () => {
      ...
      cy.get('#mat-input-107').click().wait(1000);
    });
    ...
    it('Link do componente de busca - Caixa ', () => {
      cy.get('#mat-input-108').click().wait(1000);
      // cy.get('#mat-input-62')
  ...
  context('Adicionando Recebimentos de PIX', () => {
    ...
    it('PIX', () => {
      ...
      cy.get('#button-create').click().wait(1000);
      // cy.get('[formcontrolname="descricao"]').click().wait(1000);
      cy.get('#mat-input-87').click().wait(1000);
    });
    ...
    it('Link do componente de busca - Caixa ', () => {
      cy.get('#mat-input-88').click().wait(1000);
      // cy.get('#mat-input-62')
    ...
    it('Link do componente de busca - Administradora ', () => {
      // cy.get('#mat-input-107')
      cy.get('#mat-input-60').click().wait(1000);
  ...
  context('Adicionando Recebimentos de Carteira Digital', () => {
    ...
    it('CARTEIRA DIGITAL', () => {
      ...
      cy.get('#button-create').click().wait(1000);
      // cy.get('[formcontrolname="descricao"]').click().wait(1000);
      cy.get('#mat-input-82').click().wait(1000);
    });
    ...
    it('Link do componente de busca - Caixa ', () => {
      cy.get('#mat-input-83').click().wait(1000);
      // cy.get('#mat-input-62')
    ...
    it('Link do componente de busca - Administradora ', () => {
      // cy.get('#mat-input-107')
      cy.get('#mat-input-57').click().wait(1000);
  ...
  context('Adicionando Recebimentos de Cheque A Vista', () => {
    ...
    it('Cheque A Vista - Componente busca - PDV', () => {
      cy.get('#mat-input-106').click().wait(1000);
      cy.buscarComp(dados.pdv).then((modalTitle) => {
        cy.log(`Modal utilizado: ${modalTitle}`)
        // Aqui você pode adicionar verificações do que acontece após o clique
      }
    ...
    it('Cheque A Vista - Componente busca - Cliente', () => {
      cy.get('#mat-input-74').click().wait(1000);
    ...
    it('Cheque A Vista - Componente busca - Cidade', () => {
      cy.get('#mat-input-89').click().wait(1000);
    ...
    it('Cheque A Vista - Dados', () => {
      cy.get('#mat-input-84').clear().type(dados.cheque.Comp).wait(500);
      cy.get('#mat-input-85').clear().type(dados.cheque.Banco).wait(500);
      cy.get('#mat-input-86').clear().type(dados.cheque.Ag).wait(500);
      cy.get('#mat-input-87').clear().type(dados.cheque.Conta).wait(500);
      cy.get('#mat-input-88').clear().type(dados.cheque.Cheque).wait(500);
  ...
  context('Adicionando Recebimentos de Convenio', () => {
    ...
    it('Convenio - Componente busca - PDV', () => {
      cy.get('#mat-input-90').click().wait(1000);
      cy.buscarComp(dados.pdv).then((modalTitle) => {
        cy.log(`Modal utilizado: ${modalTitle}`)
        // Aqui você pode adicionar verificações do que acontece após o clique
      }
    ...
    it('Convenio - Componente busca - Caixa ', () => {
      cy.get('#mat-input-91').click().wait(1000);
      cy.buscarComp(dados.caixa).then((modalTitle) => {
        cy.log(`Modal utilizado: ${modalTitle}`)
        // Aqui você pode adicionar verificações do que acontece após o clique
      });
    ...
    it('Convenio - Componente busca - Cliente', () => {
      cy.get('#mat-input-61').click().wait(1000);
    ...
    it('Convenio - Componente busca - Produto ', () => {
      ...
      cy.get('#mat-input-97').click().wait(500);
      ...
      cy.contains('td', dados.produto)
        .parent('tr')
        .click()
      cy.get('#mat-input-98').clear().type('10').wait(500);
      cy.get('#mat-input-101').clear().type('10').wait(500);
    ...
    it('Adicionando Valor ', () => {
      cy.get('#mat-input-68').clear().type('100').wait(500);
  ...
  context('Validando os valores', () => {
    ...
    it('Valida se todos os valores foram incrementados corretamente', () => {
      ...
      cy.visit('/movimentos/caixas-de-venda');
      cy.get(':nth-child(2) > .cdk-column-edit_delete > crud_edit > #link-edit > .mat-icon')
        .click();
