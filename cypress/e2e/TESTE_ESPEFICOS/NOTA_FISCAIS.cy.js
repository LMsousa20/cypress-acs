describe('EMISSAO DE NOTAS', () => {
  ...
  const dados =
  {
    ...
    pdv: 'LUCAS',
    valorAdicionar: 100,
    CodBarras: '7894900709926',
    produto: '0000000856 - CCOLA ZERO PET 2L C/06',
    administradoras: {
      credito: 'AMERICA',
      debito: 'VISA DEB',
      pix: 'PIX BAIXA NAO',
  ...
  context('Setup Inicial', () => {
    ...
    it('ACESSANDO TELA DE NOTA', () => {
      ...
      cy.visit('/movimentos/notas-fiscais/saida/create').wait(1000);
...
it('Numero da Nota', () => {
      cy.get('#mat-input-11').click().wait(500).type('467959921').wait(500);
 ...
 it('VALIDANDO O ENVIO - OK ', () => { 
    ...
    cy.url({ timeout: 10000 }).then((url) => {
      ...
      if (url.includes('/movimentos/notas-fiscais/saida')) {
